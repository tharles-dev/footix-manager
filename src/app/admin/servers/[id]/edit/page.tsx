...
export default function EditServerPage({ params }: EditServerPageProps) {
  ...
  const formattedServer: ServerData = {
    ...
    allow_free_agent_signing_outside_window:
      server.allow_free_agent_signing_outside_window || false,
